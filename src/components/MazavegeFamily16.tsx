          ...
          <ScrollAnimationWrapper disabled={true}>
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "バジルソースにAchieveを混ぜる", EN: "Mix Achieve into basil sauce" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      ...
                      <p>{t({ JP: "①ジェノベーゼに必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                  ...
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※ジェノベーゼソースに混ぜたあとにパスタを絡めることでAchieveが混ざりやすくなります。", EN: "*After mixing Achieve into genovese sauce, toss it with pasta so it blends more easily." })}</p>
                    <p>{t({ JP: "※あらかじめジェノベーゼソースに混ぜて用意しておくのもおすすめです。", EN: "*It is also recommended to prepare the Genovese sauce mixed with Achieve in advance." })}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="u2 mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "オイルソースにAchieveを混ぜる", EN: "Mix Achieve into basil sauce" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 直接使用のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【うっすらと色をつけたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①ペペロンチーノに必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/5本", EN: "1/5 stick" })}</span></p>
                    </div>
                  ...
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※オイルソースに混ぜたあとにパスタを絡めることでAchieveが混ざりやすくなります。", EN: "*After mixing Achieve into the oil-based sauce, toss it with the pasta so it blends more easily." })}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      ...
                      <p>{t({ JP: "①マルゲリータに必要な材料", EN: "①Ingredients for Margherita" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：タバスコに混ぜる場合）", EN: "(e.g., when mixed into Tabasco)" })}</p>
                    </div>
                  ...
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※タバスコ等、調味料にAchieveを混ぜたものを用意しておくのがおすすめです。", EN: "*It is recommended to prepare Achieve mixed with Tabasco or other seasonings." })}</p>
            ...
            <div className="mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "仕上げにAchieveを混ぜる", EN: "Mix Achieve as a finishing touch" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 直接使用のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【うっすらと色をつけたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①リゾットに必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                    </div>
