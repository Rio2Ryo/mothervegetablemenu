          ...
          <ScrollAnimationWrapper disabled={true}>
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "トッピングにAchieveを使う", EN: "Use Achieve as a topping" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      ...
                      <p>{t({ JP: "①カプレーゼに必要な材料", EN: "①Ingredients for Caprese" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：オリーブオイルに混ぜる場合）", EN: "(e.g., when mixed into olive oil)" })}</p>
                    </div>
                  ...
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※オリーブオイル等、調味料にAchieveを混ぜたものを用意しておくのがおすすめです。", EN: "*It is recommended to prepare Achieve mixed with olive oil or other seasonings." })}</p>
            ...
            <div className="u2 mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "サラダにAchieveをふりかける", EN: "Mix Confidence into salad dressing" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 直接使用のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【調味料に混ぜたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①サラダに必要な材料", EN: "①Ingredients for salad" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：ドレッシングに混ぜる場合）", EN: "" })}</p>
                    </div>

                    {/* ボトルに混ぜる場合のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【そのままふりかけたい場合の目安量】", EN: "【Recommended amount for a stronger color】" })}</p>
                      <p>{t({ JP: "①サラダに必要な材料", EN: "①Ingredients for salad" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1本", EN: "1/2 stick" })}</span></p>
                    </div>
                  </div>
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※ドレッシング等、調味料にAchieveを混ぜたものを用意しておくのがおすすめです。", EN: "" })}</p>
                    <p>{t({ JP: "（Achieveが沈殿するため、使用前に混ぜてください）", EN: "" })}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="u3 mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "Achieveを混ぜたペーストを塗る", EN: "Spread Achieve-mixed paste" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 直接使用のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      ...
                      <p>{t({ JP: "①ブルスケッタに必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：ペーストに混ぜる場合）", EN: "(e.g., when mixed into the paste)" })}</p>
                    </div>
                  ...
                  <div className="text-white space-y-2 text-xs md:text-sm mt-4">
                    <p>{t({ JP: "※あらかじめペーストに混ぜて用意しておくのがおすすめです。", EN: "**It is recommended to prepare the paste mixed with Achieve in advance." })}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "生地にAchieveを練り込む", EN: "Knead Achieve into dough" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 直接使用のセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【うっすらと色をつけたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①ラザニアに必要な材料", EN: "①Ingredients for Lasagna" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/5本", EN: "1/5 stick" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：1回の生地 600g程度に混ぜる場合）", EN: "(e.g., mixed into about 600g of per batch)" })}</p>
                    </div>
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【しっかりと色をつけたい場合の目安量】", EN: "【Recommended amount for a stronger color】" })}</p>
                      <p>{t({ JP: "①ラザニアに必要な材料", EN: "①Ingredients for Lasagna" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "2本", EN: "2 sticks" })}</span></p>
                      <p className="text-xs md:text-sm">{t({ JP: "（例：1回の生地 600g程度に混ぜる場合）", EN: "(e.g., mixed into about 600g of per batch)" })}</p>
                    </div>
                  </div>
                </div>
