        ...
        <div className="max-w-5xl mx-auto space-y-8">
          <ScrollAnimationWrapper disabled={true}>
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "仕上げにAchieveを混ぜ込む", EN: "Mix Achieve in as a finishing touch" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      ...
                      <p>{t({ JP: "①かき玉汁に必要な材料", EN: "①Ingredients for egg drop soup" })}</p>
            ...
            <div className="u2 mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              {/* タイトル */}
              <h2 className="text-white text-xl md:text-3xl font-bold mb-8 text-left">
                {t({ JP: "春雨サラダ", EN: "Glass Noodle Salad" })}
              </h2>
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-1/3 flex-shrink-0">
                  <img
                    src="achieve-howto/c2.jpg"
                    alt="Glass Noodle Salad"
                    className="w-full h-auto"
                  />
                </div>
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "仕上げにAchieveを混ぜ込み、ふりかける", EN: "Mix Achieve in as a finishing touch and sprinkle on top" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 薄い色合いのセクション */}
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【うっすらと色をつけたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①麻婆豆腐に必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                    </div>
                  ...
                  <p className="text-xs md:text-sm mt-4">{t({ JP: "※麻婆豆腐をお椀に盛ったあと、仕上げとしてAchieveをふりかけるのがおすすめです。", EN: "*It is recommended to sprinkle Achieve on top as a finishing touch after ladling the Mapo Tofu into a bowl." })}</p>
                </div>
              </div>
            </div>
            <div className="mt-10 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl px-6 md:px-12 py-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <h3 className="text-green-400 text-sm md:text-2xl font-bold text-center">
                    {t({ JP: "タレにAchieveを混ぜる", EN: "Mix Achieve into the sauce" })}
                  </h3>
                  {/* 横並びの2つのセクション */}
                  <div className="flex flex-col md:flex-row gap-6">
                    {/* 薄い色合いのセクション */}
                    <div className="flex-1 text-white space-y-2 text-xs md:text-base">
                      <p className="font-semibold">{t({ JP: "【うっすらと色をつけたい場合の目安量】", EN: "【Recommended amount for a light tint of color】" })}</p>
                      <p>{t({ JP: "①小籠包に必要な材料　1人前", EN: "①Ingredients for 1 serving" })}</p>
                      <p>{t({ JP: "②", EN: "②" })}Achieve  <span style={{ color: '#4ade80' }}>{t({ JP: "1/10本", EN: "1/10 stick" })}</span></p>
                    </div>
                  ...
                  <p className="text-xs md:text-sm mt-4">{t({ JP: "※酢醤油等、調味料にAchieveを混ぜたものを用意しておくのもおすすめです。（Achieveが沈殿するため、使用前に混ぜてください）", EN: "*It is also recommended to prepare Achieve mixed with seasonings such as vinegar or soy sauce. (Shake or stir before use, as Achieve can settle at the bottom.)" })}</p>
                </div>
              </div>
            </div>
